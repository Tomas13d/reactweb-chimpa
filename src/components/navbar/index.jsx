    ...
    <>
      <nav id="navbar" className={`navbar custom-nav`}>
        <Container fluid className="container position-relative">
          ...
          <Navbar.Brand
            href="/"
            className="col-12 d-flex justify-content-center d-md-none"
          >
            <ImgIsoOjos customClass="mobile-eyes" />
          </Navbar.Brand>
          <div className="d-flex align-items-center">
            ...
            <div className="d-none d-md-block">
              <input
                ...
                className="toggler"
                id="toggleButton"
                onClick={() => setActiveMenu((activeMenu) => !activeMenu)}
              />
              <div
                className={`hamburger ${activeMenu ? "checked" : ""}`}
                id="hamburger"
              >
                <div></div>
              </div>
        ...
        <div className={`menu ${activeMenu ? "checked" : ""}`} id="menu">
          <div>
            ...
            <div>
              <ul className="p-0">
                <li className="mb-4">
                  <ImgIsoOjos customClass="eyes-illustration" />
                </li>
                <li>
                  <a className="ff-circularBold" href="desarrollo-web.php">
                    Web UX UI
                  </a>
                </li>
                ...
                <li>
                  <a className="ff-circularBold" href="#form" id="link">
                    Contacto
                  </a>
                </li>
              </ul>
